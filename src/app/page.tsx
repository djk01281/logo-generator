      ...
      {session?.user && (
        <>
          ...
          <div>
            <Link
              href="/editor"
              className={` transform rounded-md bg-purple-500  px-6 py-3 text-center font-medium text-white no-underline  transition   hover:translate-y-[-2px] hover:border-[1px] hover:border-violet-500 hover:bg-violet-500`}
            >
              Edit SVG
            </Link>
          </div>
